...
export default function FinesReportPage() {
 ...
 <motion.div
 whileHover={{ scale: 1.02 }}
 className="bg-sidebar border border-green-500/20 rounded-2xl p-6 shadow-lg"
 >
 <div className="flex items-center justify-between">
 <div>
 ...
 <motion.div
 whileHover={{ scale: 1.02 }}
 className="bg-sidebar border border-yellow-500/20 rounded-2xl p-6 shadow-lg"
 >
 <div className="flex items-center justify-between">
 <div>
 ...
 <motion.div
 whileHover={{ scale: 1.02 }}
 className="bg-sidebar border border-red-500/20 rounded-2xl p-6 shadow-lg"
 >
 <div className="flex items-center justify-between">
 <div>
 ...
 className="px-4 py-3 bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl text-sm font-black uppercase tracking-widest transition-all flex items-center gap-2 shadow-lg"
 >
 ...
 <span className="text-base font-bold text-white">{report.staffName}</span>
 </div>
 </td>
 <td className="px-6 py-4">
 <span className="text-base text-gray-300">{report.reason}</span>
 </td>
 ...
 <div className="text-sm text-gray-400 space-y-2 font-medium leading-relaxed">
