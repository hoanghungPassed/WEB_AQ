...
export default function EmployeePhoneListPage() {
 ...
 <div className="bg-sidebar/40 border border-white/5 rounded-2xl p-6 flex flex-col justify-between h-24">
 ...
 className="bg-black/20 border border-white/10 rounded-xl pl-10 pr-4 h-10 text-sm text-white outline-none focus:border-gold/50 transition-all w-full sm:w-64"
 type="text" 
 value={searchTerm}
 ...
 p.status ==="Lỗi" ?"bg-red-500/10 text-red-500 border-red-500/20" :"bg-gray-500/10 text-gray-400 border-white/5"
 }`}>
 {p.status}
 </span>
 </td>
