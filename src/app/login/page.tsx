...
function LoginForm() {
 ...
 className="w-full rounded-xl border border-gray-600 bg-gray-800 px-4 py-3 pl-14 text-lg text-white transition-all focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500 shadow-inner placeholder-gray-400 placeholder-gray-500"
 />
 </div>
 </div>
 ...
 className="w-full rounded-xl border border-gray-600 bg-gray-800 px-4 py-3 pl-14 pr-14 text-lg text-white transition-all focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500 shadow-inner placeholder-gray-400 placeholder-gray-500"
 />
 <button
 type="button"
