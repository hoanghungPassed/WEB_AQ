...
export default function RegisterPage() {
  ...
  const inputClass = (name: string) => `h-14 w-full rounded-2xl border ${errors[name] ? "border-red-500 bg-red-50/50 dark:bg-red-900/20" : "border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"} pl-14 pr-6 text-sm focus:outline-none focus:ring-4 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm placeholder-gray-400 dark:placeholder-gray-500 font-bold`;
            ...
            <form onSubmit={handleRegister} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6">
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input type="password" name="confirmPassword" required value={formData.confirmPassword} onChange={handleInputChange} className={`h-14 w-full rounded-2xl border ${formData.confirmPassword && formData.confirmPassword !== formData.password ? "border-red-500 bg-red-50/50 dark:bg-red-900/20 text-gray-900 dark:text-white" : formData.confirmPassword && formData.confirmPassword === formData.password ? "border-green-500 bg-green-50/50 dark:bg-green-900/20 text-gray-900 dark:text-white" : "border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"} pl-14 pr-6 text-sm focus:outline-none focus:ring-4 focus:ring-blue-500 focus:border-blue-500 transition-all shadow-sm placeholder-gray-400 dark:placeholder-gray-500 font-bold`} />
                </div>
