...
const Sidebar = ({ isCollapsed, user, windowWidth }: SidebarProps) => {
 ...
 className="fixed left-0 top-0 z-40 h-screen border-r border-white/5 bg-zinc-900 text-white flex flex-col shadow-2xl"
 >
 {/* Logo */}
 <div className={cn("flex h-24 items-center transition-all duration-300",
 isCollapsed ?"justify-center" :"px-8"
 )}>
 <div className={cn("flex items-center justify-center rounded-2xl bg-gold/5 border border-gold/10 overflow-hidden shadow-xl transition-all",
 ...
 className={cn("group flex w-full items-center justify-between rounded-2xl px-4 py-3.5 text-base font-black uppercase tracking-widest transition-all hover:bg-white/[0.03]",
 ...
 <Link
 href={item.href ||"#"}
 className={cn("group flex items-center gap-4 rounded-2xl px-4 py-3.5 text-base font-black uppercase tracking-widest transition-all hover:bg-white/[0.03]",
 ...
 className="block rounded-xl px-4 py-2.5 text-[11px] font-black uppercase tracking-widest transition-all hover:text-gold hover:bg-white bg-zinc-900/[0.02] flex items-center"
 >
 {subContent}
 </a>
 );
 ...
 <Link
 key={sub.title} href={sub.href}
 className={cn("block rounded-xl px-4 py-2.5 text-[11px] font-black uppercase tracking-widest transition-colors hover:text-gold",
 pathname === sub.href ?"text-gold bg-gold/5" :""
 )}
 >
 {subContent}
 </Link>
 ...
 <div className="border-t border-white/5 p-4 bg-zinc-900/[0.01] space-y-3">

 <div className={cn("flex items-center justify-between rounded-3xl p-3 transition-colors hover:bg-white/5 group",
 ...
 <span className="text-base font-black text-white truncate">{user?.name ||"GUEST"}</span>
 <span className="text-[9px] font-bold uppercase tracking-tighter truncate">@{user?.username ||"unknown"}</span>
 </div>
 )}
 </div>
 {!isCollapsed && (
 ...
 className="h-10 w-10 flex items-center justify-center rounded-xl hover:text-red-500 hover:bg-red-500/10 transition-all"
 title="Đăng xuất"
 >
 <LogOut size={20} />
 </button>
