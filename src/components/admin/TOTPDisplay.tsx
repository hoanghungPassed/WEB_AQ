...
export default function TOTPDisplay({ secret, compact = false, onCopy }: TOTPDisplayProps) {
 ...
 >
 <span className={`font-mono font-black text-base tracking-[0.15em] ${loading ?"" : copied ?"text-gold" : urgency} transition-colors`}>
 ...
 title="Bấm để sao chép mã 2FA"
 >
 <div className={`text-4xl font-black tracking-[0.3em] text-center ${loading ?"" : copied ?"text-gold" : urgency} transition-colors`}>
